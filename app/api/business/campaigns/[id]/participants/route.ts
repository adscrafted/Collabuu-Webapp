  ...
  try {
    ...
    const participantsWithStats = await Promise.all(
      (applications || []).map(async (app) => {
        // Count visits generated by this influencer
        ...
        // Count unique customers (distinct customer_ids from visits)
        ...
        const customerCount = uniqueCustomers ? new Set(uniqueCustomers.map(v => v.customer_id)).size : 0;
